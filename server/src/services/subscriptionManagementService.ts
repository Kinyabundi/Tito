...
export class SubscriptionManagementService {
	...
	async createSubscription(subscriptionData: {
		...
		try {
			...
			const existingSubscription = await this.subscriptionRepository.findUserServiceSubscription(subscriptionData.user_id, subscriptionData.service_id);
	...
	async renewSubscriptionAfterPayment(subscriptionId: string, paymentAmount: number, transactionHash?: string): Promise<ISubscription | null> {
		try {
